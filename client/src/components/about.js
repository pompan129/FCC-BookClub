      ...
      <div className={props.classes.about}>
        <div>
          ...
          <ul>
            ...
            <li>
              <Typography>I can add a new book.</Typography>{" "}
            </li>
            <li>
              <Typography>
            ...
            <li>
              <Typography>
                I can propose a trade and wait for the other user to accept the
                trade.
              </Typography>
            </li>
          </ul>
        ...
        <div className={props.classes["logo-list"]}>
          <a href="https://reactjs.org/">
            <span
              className={props.classes.logoSpan}
              style={{ backgroundColor: "#006c80" }}
            >
              <ReactLogo />
              <Typography
                variant="subheading"
        ...
        <div className={props.classes["logo-list"]}>
          ...
          <a href="https://expressjs.com/">
            <span
              className={props.classes.logoSpan}
              style={{ backgroundColor: "#eee", height: "2rem" }}
            >
